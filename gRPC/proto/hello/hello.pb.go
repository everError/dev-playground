...
const file_proto_hello_proto_rawDesc = "" +
	...
	"\x0eSayHelloStream\x12\x13.hello.HelloRequest\x1a\x11.hello.HelloReply0\x01B\rZ\vproto/hellob\x06proto3"
...
var file_proto_hello_proto_depIdxs = []int32{
	...
	1, // 3: hello.HelloService.SayHelloStream:output_type -> hello.HelloReply
